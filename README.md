...
- **Виділив ім'я персонажа в тексті → «Додати персонажа».**
  ...
  характер, звʼязки з іншими персонажами (завжди в одному напрямку — "хто
  цей персонаж для когось", напр. "донька короля", не навпаки),
...
- **Виділив будь-який уривок → «Додати до персонажа».**
  ...
  об'єднує старе й нове стисло, без дублювання змісту (розпізнає навіть
  синоніми — "лисий" і "без волосся" не стануть двома окремими записами).
  Списки (псевдоніми, звʼязки) поповнюються з дедуплікацією.
